...
/*
    ...
    Esta clase se genero automaticamente se llama Entity classes from DataBase de la carpeta de persistencia
    ,el cual es una entidad de base de datos mapeada a java
*/
@Entity
