...
/*
    ...
    Esta clase se genero automaticamente se llama JPA Controller classes from Entity Classes de la carpeta de persistencia
    ,el cual es un JPA que se conecta con la base de datos
*/
